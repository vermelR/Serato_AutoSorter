"""
Local, offline genre classifier used as a fallback when audio fingerprinting
(identify.py) can't find a confident match for a track (no internet, no
AcoustID key, or the song just isn't in MusicBrainz).
